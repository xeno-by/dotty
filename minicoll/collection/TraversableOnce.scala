...
object TraversableOnce {
  ...
  private[collection] abstract class BufferedCanBuildFrom[A, CC[X] <: TraversableOnce[X]] extends generic.CanBuildFrom[CC, A, CC[A]] {
     ...
     */
    def apply(from: TraversableOnce[_]): Builder[A, CC[A]] = from match {
